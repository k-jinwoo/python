...
while True :
    try :
        ...
        if answer == 0 :
            ...
            raise Exception('음수는 안됩니다.') # 0보다 작은 -(음수)를 적었을 때 에러를 만들어 except로 보냄

        result = animal[answer - 1] # 배열은 0부터 시작이라서 -1 을 넣어줌
